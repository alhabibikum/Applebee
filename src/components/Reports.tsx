...
export function Reports() {
  ...
  return (
    <div className="space-y-4 sm:space-y-6 px-2 sm:px-0">
        ...
        <div className="bg-white rounded-lg shadow p-4 sm:p-6 border border-gray-200">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <div className="text-center p-3 bg-green-50 rounded-lg">
              ...
              <p className="text-xs sm:text-sm text-gray-500 mt-1">Current Stock</p>
            </div>
            <div className="text-center p-3 bg-green-50 rounded-lg">
              <p className="text-lg sm:text-xl font-bold text-green-600">৳{stats.newProducts.value.toLocaleString('en-BD')}</p>
              <p className="text-xs sm:text-sm text-gray-500 mt-1">Investment Value</p>
            </div>
            <div className="text-center p-3 bg-green-50 rounded-lg">
      ...
      <div className="bg-white rounded-lg shadow p-4 sm:p-6 border border-gray-200">
        <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Overall Business Statistics</h3>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 sm:gap-6">
          ...
          <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg">
            ...
            <p className="text-xs sm:text-sm text-gray-500 mt-1">Product Types</p>
          </div>
          <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg">
          ...
          <div className="text-center p-3 sm:p-4 bg-gray-50 rounded-lg">
            <p className="text-xl sm:text-2xl font-bold text-red-600">{stats.lowStockAlerts}</p>
      ...
      <div className="bg-white rounded-lg shadow p-4 sm:p-6 border border-gray-200">
        <h3 className="text-base sm:text-lg font-semibold text-gray-900 mb-4">Investment & Revenue Analysis</h3>
